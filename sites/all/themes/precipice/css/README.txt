...
To use these stylesheets, rename the files and precipice with the name of your theme.
...
precipice-alpha-default-narrow.css  
...
precipice-alpha-default-normal.css
...
precipice-alpha-default-wide.css
